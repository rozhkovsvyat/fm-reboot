...
- **Итого (конфиг a):** Suno ~$10 + AceData ~$1–15 ≈ **~$11–25/мес**.
- ✅ **Уточнено ресёрчем ([[drafts/acedata-pricing-research]], 2026-06-21):** своя Suno-подписка для AceData
  **НЕ нужна** → **конфиг (b) рабочий** (только кредиты AceData, без $10 Suno). Pure pay-as-you-go; кредит ≈
  $0.013–0.018; точные per-op тарифы скрыты за авторизацией (мерить на пробных кредитах). SunoMCP — бесплатный
  (MIT). Главный минус — надёжность (PiAPI/GoAPI закрылись в 2025).
